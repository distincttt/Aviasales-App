  ...
  return (
    <div className={classes.ticket}>
      <div className={classes['ticket__header']}>
        ...
        <img src={`https://pics.avs.io/110/40/${ticket.carrier}.png`} />
      </div>
      <div className={classes['ticket__back-there']}>
        <div className={classes['ticket__back-there__info']}>
          ...
          <span className={classes['ticket__back-there__info-black']}>
            ...
            {format(add(new Date(ticket.segments[0].date), { minutes: ticket.segments[0].duration }), 'HH:mm')}
          </span>
        </div>
        <div className={classes['ticket__back-there__info']}>
          <span className={classes['ticket__back-there__info-gray']}>В ПУТИ</span>
          <span className={classes['ticket__back-there__info-black']}>
            {Math.floor(ticket.segments[0].duration / 60)}ч {ticket.segments[0].duration % 60}м
          </span>
        </div>
        <div className={classes['ticket__back-there__info']}>
          <span className={classes['ticket__back-there__info-gray']}>{stopThere}</span>
          <span className={classes['ticket__back-there__info-black']}>{ticket.segments[0].stops.join(',')}</span>
        </div>
      </div>
      <div className={classes['ticket__back-there']}>
        <div className={classes['ticket__back-there__info']}>
          ...
          <span className={classes['ticket__back-there__info-black']}>
            ...
            {format(add(new Date(ticket.segments[1].date), { minutes: ticket.segments[1].duration }), 'HH:mm')}
          </span>
        </div>
        <div className={classes['ticket__back-there__info']}>
          <span className={classes['ticket__back-there__info-gray']}>В ПУТИ</span>
        ...
        <div className={classes['ticket__back-there__info']}>
          <span className={classes['ticket__back-there__info-gray']}>{stopBack}</span>
          <span className={classes['ticket__back-there__info-black']}>{ticket.segments[1].stops.join(',')}</span>
        </div>
      </div>
    </div>
  )
